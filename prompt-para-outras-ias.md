...
6. **Playlist do casal com player do Spotify embutido**: cards misturando músicas de Crepúsculo (A Thousand Years — Christina Perri, Flightless Bird American Mouth — Iron & Wine, Bella's Lullaby — Carter Burwell) com aberturas de Naruto (Blue Bird — Ikimono-gakari, Silhouette — KANA-BOON, Sign — FLOW). Cada card tem botão de play que carrega um iframe embed do Spotify (`https://open.spotify.com/embed/track/ID?utm_source=generator&theme=0`, altura 152px) dentro do card; apenas um player aberto por vez (abrir outro fecha o anterior); o botão vira "parar" (■) enquanto o player está aberto; a faixa em reprodução mostra um **mini equalizador animado** ao lado do nome.
